  ...
  return {
    ...
    scripts: [
      {
        ...
        "runllm-algolia-api-key": "933f1365f746f5207fab11bf4b55292f",
        "runllm-algolia-application-id": "XFI8PX63MB",
        "runllm-algolia-index-name": "geteppo", 
        "runllm-algolia-filters": "[]",
    ...
    ({
      announcementBar: {
        ...
        content: '<strong>Webinar: Join our next live demo</strong> &nbsp; April 8th at 11am PT / 2pm ET &nbsp;<a target="_blank" rel="noopener noreferrer" href="https://us06web.zoom.us/webinar/register/WN_HQuy1FIOTV6g3jdPOyD0ig">Register now →</a>',
