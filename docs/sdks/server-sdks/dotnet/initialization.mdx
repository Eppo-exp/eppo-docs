...
<ApiOptionRef 
  name="HttpClient"
  type="HttpClient"
  defaultValue="new HttpClient()"
>

The HTTP client used for making requests to the Eppo API. You can provide a custom client to handle things like timeouts and retries.
</ApiOptionRef>
