...
```bash
npm install @eppo/js-server-sdk
```
...
```js
import init from "@eppo/js-server-sdk";
...
```js
import * as EppoSdk from "@eppo/js-server-sdk";
...
import { IAssignmentLogger, init } from "@eppo/js-server-sdk";
