...
logging systems in the [Assignment page](/sdks/client-sdks/flutter/assignments/#logging-data-to-your-data-warehouse).
:::
...
- [Initialization Configuration](/sdks/client-sdks/flutter/initialization)
- [Assignment details](/sdks/client-sdks/flutter/assignments)
