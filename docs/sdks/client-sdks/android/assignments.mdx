...
Here are examples of integrating with popular analytics providers:

<Tabs>
<TabItem value="firebase" label="Firebase Analytics">
...
AssignmentLogger logger = new AssignmentLogger() {
    ...
    public void logAssignment(Assignment assignment) {
        ...
        params.putString("experiment", assignment.getExperiment());
        params.putString("variation", assignment.getVariation());
        params.putString("subject", assignment.getSubject());
        
        FirebaseAnalytics.getInstance(context)
            .logEvent("eppo_assignment", params);
    }
};
```

</TabItem>
<TabItem value="mixpanel" label="Mixpanel">
...
AssignmentLogger logger = new AssignmentLogger() {
    ...
    public void logAssignment(Assignment assignment) {
        ...
        props.put("experiment", assignment.getExperiment());
        props.put("variation", assignment.getVariation());
        props.put("subject", assignment.getSubject());
        
        MixpanelAPI mixpanel = MixpanelAPI.getInstance(context, MIXPANEL_TOKEN);
        mixpanel.track("Eppo Assignment", props);
    }
};
```
