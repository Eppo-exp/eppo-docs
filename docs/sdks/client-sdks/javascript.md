...
| **`maxCacheAgeSeconds`** (number)                 | Maximum age, in seconds, previously cached configurations are considered valid and fetching an update configurations will be skipped                                                                                                                                                                                                   | `0`             |
