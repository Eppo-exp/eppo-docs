...
Experiments are a way to compare two or more variants of a feature to determine which one performs better. They are similar to feature flags but they require that you include a function that logs events from your application to a data store you control.
