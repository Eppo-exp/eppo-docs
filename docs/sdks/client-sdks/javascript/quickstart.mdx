...
After that, just make assignments the same way you would for an experiment. Eppo will optimize the configuration for assignments based on the user's context and handle the logging based on the function you provided.
...
- [High Level concepts for the client API](/sdks/client-sdks/index)
...
- [Using the SDK with React](/sdks/client-sdks/javascript/react) if you are using React
- [Using the SDK with Next.js](/sdks/client-sdks/javascript/nextjs) if you are using Next.js