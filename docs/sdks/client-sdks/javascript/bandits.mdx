...
Metadata about numeric attributes of the assigned action. Map of the name of attributes their provided values. Example: `{"brandAffinity": 0.2}`
</ApiOptionRef>
...
Metadata about non-numeric attributes of the assigned action. Map of the name of attributes their provided values. Example: `{"previouslyPurchased": false}`
</ApiOptionRef>
...
Any additional freeform meta data, such as the version of the SDK. Example: `{ "sdkLibVersion": "3.5.1" }`
</ApiOptionRef>
