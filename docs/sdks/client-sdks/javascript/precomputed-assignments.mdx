...
The precomputed client can be accessed anywhere in your application.

Flag evaluation simply looks up the precomputed assignment and returns quickly,
returning the default value if missing.
