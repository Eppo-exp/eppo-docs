...
You can use the assignment logging functions to send data to any data warehouse or logging system you want, including Eppo's [Event Tracking](/event-logging/event-tracking), or your own custom solution.
