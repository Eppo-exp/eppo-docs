...
Starting in version `1.4.0`, Eppo's SDK by default attempts to cache assignment events using the `NonExpiringAssignmentCache` 
...
For the Javascript SDK we recommend using the provided class:
