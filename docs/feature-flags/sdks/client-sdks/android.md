...
```groovy
implementation 'cloud.eppo:android-sdk:0.1.1'
```
...
- `flagKey` - This key is available on the detail page of for both flags and experiments. Can also be an experiment key.
