...
[experiment setup page](/experiment-analysis/configuration#analysis-plan-settings).
...
[Precision](/experiment-analysis/reading-results/progress-bar#precision) captures the uncertainty in the point estimate as defined by the width of the confidence interval.
...
This is used to power the [progress bar](/experiment-analysis/reading-results/progress-bar),
