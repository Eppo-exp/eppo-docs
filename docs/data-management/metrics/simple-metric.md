...
:::note
If you are using an [Entry Point](/data-management/filter-assignments-by-entry-point.md), the starting point of the time frame is the Entry Point timestamp.
:::
